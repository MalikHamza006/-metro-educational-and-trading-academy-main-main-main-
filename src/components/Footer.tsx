import { LineChart, Mail, MapPin, Phone, ShieldCheck, ExternalLink, Globe } from 'lucide-react';
...
export default function Footer({ setPath }: FooterProps) {
  ...
  return (
    <footer className="bg-[#FAF9F9] border-t border-red-500/15 relative overflow-hidden text-slate-600">
      {/* Subtle backing glow for aesthetic finish */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-left">
              ...
              <li>
                <a href="#trading-dashboard" className="hover:text-primary-red text-slate-700 transition-colors flex items-center gap-1">
                  <span>Live Simulator Terminal</span>
